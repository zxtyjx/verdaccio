...
const lock_and_read_json = function(name, cb) {
...
const create_json = function(name, value, cb) {
  create(name, JSON.stringify(value, null, '\t'), cb);
};

const update_json = function(name, value, cb) {
  update(name, JSON.stringify(value, null, '\t'), cb);
};

const write_json = function(name, value, cb) {
  write(name, JSON.stringify(value, null, '\t'), cb);
};

module.exports.lock_and_read = lock_and_read;
module.exports.lock_and_read_json = lock_and_read_json;
